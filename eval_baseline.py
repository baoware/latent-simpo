...
def main():
    ...
    print(f"Model: {cfg.vjepa_model} + {cfg.llama_model}")
    ...
    # Predictor gets normal LR, Y-Encoder gets 0.05x LR
    ...
    dataloader = DataLoader(dataset, batch_size=cfg.batch_size_p1, shuffle=True, num_workers=4)
    ...
    for epoch in range(cfg.epochs_p1):
        total_loss = 0
        progress = tqdm(dataloader, desc=f"Epoch {epoch+1}/{cfg.epochs_p1}")
